        ...
        <section>
          ...
          <div class="-mt-16 mb-8 px-8 ">
            <div class="container mx-auto">
              <div class="py-3 flex justify-center rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200">
                <div class="my-2 grid gap-6 px-4">
                  <div class="p-6 px-2 sm:pr-6 sm:pl-4">
                    <h4 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-blue-gray-900 mb-2 normal-case transition-colors">Guidelines for Swimming Pool Membership</h4>
                    <div class="block antialiased font-sans text-base leading-relaxed text-inherit mb-8 font-normal !text-gray-500">
