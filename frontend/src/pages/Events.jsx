            ...
            <div className="sm:col-span-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="text-lg sm:text-xl md:text-xl lg:text-xl h-full flex flex-col justify-between">
                  <DateCard
                    title={"Holidays"}
                    events={"Navam Fullmoon poya day"}
                    img={datebox2}
                  />
                </div>
              </div>
          ...
          <div className="col-span-3 mt-8 sm:px-2 md:px-4">
            ...
            <div className="flex justify-center mt-4">
              <button
                ...
                className="bg-yellow-300 text-black hover:bg-yellow-500 px-4 py-2 rounded w-full"
              >
                Back
              </button>
            </div>
