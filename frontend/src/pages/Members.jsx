...
const Members = () => {
  ...
  const imageUrlGround = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKTlfKV-33el_swtTqaO63TRfmeDEUb55zlA&s";
  const imageUrlGym = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKDWg1zq64xccwiMYVtHxmAty40QKKBxIahw&s";

  return (
    <div className="container mx-auto px-4 py-8">
      <div>
        <h3 className="text-xl md:text-2xl font-bold pb-4">Hello Sathija 👋🏼,</h3>
      </div>
      ...
      <div className="text-center py-8">
        <h1 className="text-3xl md:text-5xl font-bold mb-4">Unlock Your Wellness Journey</h1>
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          Discover a world of fitness possibilities with our exclusive memberships, trends, and more. See who&apos;s joining the community, read about how our community is increasing their membership income, and lots more.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <Link to='/members/membersGym'>
          <Card content="High-tech gym for customized workouts" backgroundImage={imageUrlGym} />
        </Link>
        <Link to='/members/membersGround'>
          <Card content="Serene grounds for outdoor workouts" backgroundImage={imageUrlGround} />
        </Link>
        <Link to='/members/membersPool'>
          <Card content="Refreshing pool for aquatic exercise or relaxation" backgroundImage={imageUrlPool} />
        </Link>
      </div>
