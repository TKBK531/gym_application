...
import CreateTeam from '../CreateTeam'; // Import the new CreateTeam component
...
function Team({ sportId }) {
  ...
  const handleConfirmAddTeamMember = async (selectedStudentIds) => {
    try {
      ...
      console.log("Response data:", req_data);
  ...
  const handleTeamCreated = () => {
    fetchTeams(); // Refresh the list of teams after a new team is created
  };
  ...
  return (
    <div className="space-y-6 p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="flex justify-between items-center">
        <div className="team-dropdown w-3/4">
          <Select
