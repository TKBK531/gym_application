...
#         slug_field="name", queryset=UserType.objects.all()
#     )
#     city = serializers.SlugRelatedField(slug_field="label", queryset=City.objects.all())
...
#         slug_field="label", queryset=City.objects.all(), required=False
#     )
