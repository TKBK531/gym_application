...
class ItemCreateView(APIView):
    def post(self, request):
        ...
        if not sport_label:
            return Response({'error': 'Sport label is required'}, status=status.HTTP_400_BAD_REQUEST)
        ...
        item_data['sport'] = sport.id  # Assuming sport is a foreign key in the Item model
